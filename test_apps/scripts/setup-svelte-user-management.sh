#!/bin/bash
# setup-svelte-user-management.sh - Setup the Svelte User Management example
...
APP_NAME="svelte-user-management"
...
# Clone the example
clone_supabase_example "examples/user-management/svelte-user-management" "$APP_NAME"

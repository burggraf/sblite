#!/bin/bash
# setup-react-user-management.sh - Setup the React User Management example
...
APP_NAME="react-user-management"
...
# Clone the example
clone_supabase_example "examples/user-management/react-user-management" "$APP_NAME"

# Generate API keys
generate_keys

# Create .env file for React (uses Vite)
create_vite_env "$APP_DIR"

#!/bin/bash
# setup-sveltekit-user-management.sh - Setup the SvelteKit User Management example
...
APP_NAME="sveltekit-user-management"
...
# Clone the example
clone_supabase_example "examples/user-management/sveltekit-user-management" "$APP_NAME"

# Generate API keys
generate_keys

# Create .env file for SvelteKit
create_sveltekit_env "$APP_DIR"

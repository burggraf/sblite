#!/bin/bash
# setup-vue3-user-management.sh - Setup the Vue 3 User Management example
...
# Clone the example
clone_supabase_example "examples/user-management/vue3-user-management" "$APP_NAME"

# Generate API keys
generate_keys

# Create .env file for Vue (uses Vite)
create_vue_env "$APP_DIR"

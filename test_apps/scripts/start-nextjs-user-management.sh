#!/bin/bash
# Start script for nextjs-user-management
...
APP_DIR="$TEST_APPS_DIR/nextjs-user-management"
...
# Start the app
log_info "Starting nextjs-user-management..."
cd "$APP_DIR"
pnpm run dev &
APP_PID=$!

log_success "nextjs-user-management started (PID: $APP_PID)"
